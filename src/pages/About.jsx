    ...
    <div>
      ...
      <Container className={classes.description}>
        ...
        <p>
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores omnis natus totam possimus assumenda, tenetur itaque hic laboriosam illum repellendus vero consequuntur, eius quidem pariatur ullam. Similique rem id voluptates ducimus ea dolor magni voluptas aliquam. Voluptatem error quibusdam odit totam doloremque necessitatibus, blanditiis modi voluptates dolor corrupti culpa. Nulla maxime iure unde at ut iusto porro, laborum amet voluptas nesciunt hic facilis impedit labore necessitatibus? Repellendus totam molestiae vero! Voluptatem cum vero fuga, excepturi ipsa accusamus expedita cumque rem adipisci, perspiciatis repellendus error sit aperiam deserunt accusantium nihil ab aliquam odit reiciendis laudantium aut? Quos adipisci modi vitae itaque.
        </p>
      </Container>
    </div>
  );
